          ...
          <div className="w-full max-w-[100rem] mx-auto px-4 flex justify-between items-center">
            ...
            <ul className="hidden lg:flex space-x-6 items-center xl:text-xl">
              ...
              <li className="relative group">
                ...
                <ul className="absolute hidden group-hover:block top-full right-0 bg-white dark:bg-gray-800 shadow-lg mt-2 w-60 rounded-md p-2 space-y-2 z-50 opacity-0 group-hover:opacity-100 transition-all duration-200">
                  <li>
                    <Link
                      href="/projects"
                      className="block text-gray-700 dark:text-gray-200 hover:text-red-600"
