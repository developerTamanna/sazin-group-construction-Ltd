...
const StatCard = ({ stat, isVisible }) => {
  ...
  return (
    <div className="flex items-center justify-center gap-4 bg-white dark:bg-gray-800 rounded-xl p-6  dark:border-gray-700 hover:shadow-lg transition duration-300">
      {/* Icon */}
      <div
