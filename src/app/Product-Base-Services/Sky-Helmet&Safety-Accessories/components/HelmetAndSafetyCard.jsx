...
const HelmetAndSafetyCard = ({data}) => {
  return (
<div className="flex flex-wrap justify-between items-center p-8 md:p-4">
 {data?.pages.map((page, i) => (
    <React.Fragment key={i}>
          {page?.data?.map((item, index) => (
       <div key={index} className="max-w-sm mx-auto bg-white dark:bg-gray-900 rounded-2xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700 transition-transform duration-300 hover:shadow-2xl hover:scale-105">
         {/* Image */}
