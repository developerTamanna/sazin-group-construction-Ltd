...
<img src={DATA.heroImage} alt="hero" className="w-full h-[360px] object-cover opacity-80" />
<div className="absolute inset-0 flex items-center">
<div className="max-w-4xl mx-auto px-6 text-white">
<h1 className="text-3xl md:text-5xl font-extrabold leading-tight">{DATA.name}</h1>
