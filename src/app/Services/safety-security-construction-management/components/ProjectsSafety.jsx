...
const projects = [
  { title: "Industrial Fire Safety System", img: "/images/projects/safety-fire.jpg" },
  { title: "Corporate CCTV & Access Control", img: "/images/projects/safety-cctv.jpg" },
  { title: "High-Rise Emergency Evacuation Setup", img: "/images/projects/safety-evacuation.jpg" },
];

export default function ProjectsSafety() {
  return (
    <section className="bg-white dark:bg-neutral-950 py-16 px-6 lg:px-8">
      <h2 className="text-3xl font-bold text-center">Sample Safety Projects</h2>
