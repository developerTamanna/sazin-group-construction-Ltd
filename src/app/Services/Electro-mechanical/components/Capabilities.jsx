...
export default function Capabilities() {
  return (
    <section className="relative mx-auto bg-neutral-50 dark:bg-neutral-900 py-20 px-4 sm:px-6 lg:px-12 transition-colors duration-500">
      <div className="max-w-6xl mx-auto text-center">
        ...
        {/* Grid */}
        <div className="mt-14 p-2 grid gap-8 grid-cols-1 sm:grid-cols-2">
          {capabilities.map((cap, idx) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                className="group flex items-start flex-wrap md:flex-nowrap gap-5 bg-white dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-700 rounded-2xl md:p-7 p-4 shadow-md hover:shadow-xl transition-all duration-500 w-full max-w-md mx-auto"
              >
                {/* Icon */}
                ...
                <div className="text-left ">
                  ...
                  <ul className="mt-3 space-y-1 text-neutral-700 dark:text-neutral-300 text-sm list-disc text-start pl-5">
                    {cap.points.map((p,index) => (
                      <li className='w-full  break-all ' key={index}>{p}</li>
                    ))}
                  </ul>
                </div>
              </motion.div>
